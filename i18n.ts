...
const fr = {
  translation: {
    ...
    tl_2_desc: "Soumission des articles (date limite)",
    ...
    modality_format_desc: "Maximum 5 pages en français ou anglais",
    ...
    label_theme_select: "Track/Thématique",
    theme_placeholder: "Sélectionnez un track...",
    track_other: "Autre",
    track_download: "Autre - Liste complète des tracks",
    ...
    option_researcher: "Chercheur/Enseignant-Chercheur",
    ...
    thematic_math_responsibles: "Prof. Babacar, Dr(MC) Soro Étienne",
    thematic_ai: "Intelligence Artificielle & Data Science",
    thematic_ai_responsibles: "Dr(MC) Mamadou Diarra, Prof. Leila Nasraoui, Dr (MC) ACHIEPO Odilon YAPO",
    thematic_networks: "Réseaux & Télécommunications",
    thematic_networks_responsibles: "Dr(MC) bamba Aliou, Prof. Asseu Olivier",
    thematic_cyber: "Cybersécurité & Systèmes d'Information",
    thematic_cyber_responsibles: "Prof. Yvon Kermarec, Dr(MC) Kamagaté Beman",
...
const en = {
  translation: {
    ...
    tl_1_date: "November 1, 2025",
    tl_1_desc: "Call for papers launch",
    tl_2_date: "February 28, 2026",
    tl_2_desc: "Paper submission deadline",
    tl_3_date: "March 30, 2026",
    ...
    modality_format_title: "Format",
    modality_format_desc: "05 maximum pages articles in French or English",
    ...
    label_theme_select: "Track/Theme",
    theme_placeholder: "Select a track...",
    track_other: "Other",
    track_download: "Other - Complete track list",
    ...
    committee_thematic_title: "Thematic Distribution of the Committee",
    thematic_math: "Mathematics & Operations Research",
    thematic_ai: "Artificial Intelligence & Data Science",
    thematic_ai_responsibles: "Dr(MC) Mamadou Diarra, Prof. Leila Nasraoui",
    thematic_networks: "Networks & Telecommunications",
    thematic_networks_responsibles: "Prof. Yvon Kermarec, Prof. Babacar",
    ...
    thematic_coordination_responsibles: "Dr(MC) Moustapha Diaby, Prof. Coulibaly Adama",
    thematic_telecom: "Expert Telecom AIGF",
    thematic_telecom_responsibles: "Dr(MC) bamba Aliou",
